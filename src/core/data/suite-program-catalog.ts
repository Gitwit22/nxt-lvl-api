...
export const suiteProgramCatalog: SuiteProgramSeed[] = [
  ...
  {
    id: "program-financial-hub",
    slug: "financial-hub",
    organizationId: null,
    name: "Financial Hub",
    shortDescription: "Finance validation, review, reporting, and export gatekeeping for operational records.",
    longDescription:
      "Financial Hub is the finance command center for intake validation, approval workflows, reporting, and exports across operational systems. It is organization-scoped and uses shared platform authentication and access controls.",
    category: "Finance",
    tags: ["finance", "compliance", "exports"],
    status: "live",
    type: "internal",
    origin: "suite-native",
    internalRoute: "/workspace/financial-hub",
    externalUrl: null,
    openInNewTab: false,
    logoUrl: null,
    screenshotUrl: null,
    ...
    launchLabel: "Launch App",
    displayOrder: 3,
    notes: "Internal suite workspace for finance operations.",
  },
  {
